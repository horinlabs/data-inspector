module.exports = {
	required: (attribute) => `The attribute \`${attribute}\` is required`,
	type: (attribute, value) => `The attribute \`${attribute}\` must be of type ${value}`,
	pattern: (attribute) => `The attribute \`${attribute}\` is invalid`,
	...
	accepted: (attribute) => `The attribute \`${attribute}\` must be accepted`,
	...
	alpha: (attribute) => `The attribute \`${attribute}\` must be entirely alphabetic characters`,
	alphaDash: (attribute) => `The attribute \`${attribute}\` may have alpha-numeric characters, as well as dashes and underscores`,
	alphaNumeric: (attribute) => `The attribute \`${attribute}\` must be entirely alpha-numeric characters`,
	email: (attribute) => `The attribute \`${attribute}\` must be formatted as an email address`,
	url: (attribute) => `The attribute \`${attribute}\` must be formatted as an url`,
	ip: (attribute) => `The attribute \`${attribute}\` must be formatted as an IP address`,
	...
	distinct: (attribute) => `All the values of the attribute \`${attribute}\` must be different`,
